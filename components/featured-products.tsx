...
const FeaturedProducts = () => {
  ...
  return (
    <div className="max-w-6xl py-10 mx-auto sm:py-16 sm:px-24 px-10">
      <h3 className="px-6 text-3xl sm:pb-8 p-2">Productos destacados</h3>

      <Carousel>
        <CarouselContent className="ml-2 md:-ml-8 px-20 md:px-0">
                ...
                >
                  <div className="p-1">
                    <Card className="py-4 border border-gray-200 shadow-none">
                      ...
                      <div className="gap-4 px-8 min-w-0 overflow-hidden items-center">
                        <h3 className="text-xl font-bold truncate text-center">
                          {productName}
                        </h3>
                      </div>
                    </Card>
