                ...
                <CarouselContent className="ml-2 md:-ml-4">
                    ...
                    {result !== null && (
                        result.map((product: ProductType) => {
                            const { id, slug, images, productName, purchase, category } = product
                                    ...
                                    <div className="p-1">
                                        <Card className="py-4 border border-gray-200 shadow-none">
                                            ...
                                            <div className="flex justify-between gap-4 px-8 min-w-0 overflow-hidden items-center flex-wrap">
                                                <h3 className="text-lg font-bold truncate whitespace-nowrap overflow-hidden text-ellipsis max-w-[60%]">{productName}</h3>
                                                <div className="flex-shrink-0 flex flex-wrap gap-2">
                                                    <ProductCategories category={category?.categoryName || ""} purchase={purchase || ""} />
                                                </div>
                                            </div>
                                        </Card>
                                    </div>
