...
/**
 * Barra de controles del listado, con estado en la URL (nuqs): búsqueda
 * (debounced), filtro por categoría, toggle "solo ofertas" y orden.
 * Cualquier cambio resetea ?page=1 y re-renderiza el server (shallow:false).
 */
const ProductsControls = ({ categories }: ProductsControlsProps) => {
